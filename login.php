<?php
  ...
  //login.php
  //This is the main login page for the project.

  //Some logic should be included
  //Brooks: The login button should take users to the main.php if it authencates properly.
...
<html lang="en">
  ...
  <body class="col-sm-8 col-sm-offset-2">
      ...
      <div class="text-center" style="padding:50px 0">
          ...
          <div class="logo">Project 4 eCommerce System</div>
          <br>
